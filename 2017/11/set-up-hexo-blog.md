...
![图 1](https://file.zhangpeng.site/2017/11/26/1.png)
...
![图 2](https://file.zhangpeng.site/2017/11/26/2.png)

创建完毕后，我们可以看到生成了很多的文件及文件夹，如下：

![图 3](https://file.zhangpeng.site/2017/11/26/3.png)
...
![图 4](https://file.zhangpeng.site/2017/11/26/4.png)
...
1. 安装插件
   ...
   在博客的根目录执行 `npm install hexo-deployer-git --save` ![图 6](https://file.zhangpeng.site/2017/11/26/6.png)
...
2. 修改配置文件
   ...
   **注：**
   ...
   2.有的同学可能会问可不可以发布到某个分支上，答案是不能。原因请看下图，箭头所指处，明确说明`User pages must be built from the master branch.` ![图 7](https://file.zhangpeng.site/2017/11/26/7.png)
