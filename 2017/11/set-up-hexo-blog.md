...
2. 创建一个用于存放博客的仓库
   ...
   ![&#x56FE;5](http://file.zhangpeng.site/2017/11/26/5.png)
...
当您看到 `INFO Deploy done： git` 时，就说明您的博客成功发布到GitHub上了，通过访问 `http：//xxx.github.io/`，就可以访问到您的博客了，记得把 `xxx` 换成您的项目名。 ![&#x56FE;8](http://file.zhangpeng.site/2017/11/26/8.png)
